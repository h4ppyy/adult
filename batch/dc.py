...
upload_dir = '/home/vagrant/project/adult/main/static/main/collect/'
...
for m in link:
    if(m.find("a", {"class":"icon_pic_n"})):
        ...
        for n in link2:
            ...
            #print "pure_file_name.encode = " + pure_file_name.encode('utf-8')
            ...
            curs = conn.cursor()
            sql = '''
                insert into picture(file_name, regist_date, file_dir)
                values('{filename}', now(), '{upload_dir}')
